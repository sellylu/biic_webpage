...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/cclee.css">
			...
			<div class="container">
				...
				<article class="box post">
					...
					<section>
						...
						<a href="./Jeremy-CV_2019-Feb.pdf" target="_blank">Jeremy's CV</a>&emsp;(update: Feb. 2019)<br>
					...
					<section>
						...
						<div id="accordion">
							...
							<div class="card-header" id="headingOne">
								<h3><button class="card-button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Invited Talks</button><small style="font-size: 70%;">&emsp;(update: Feb. 2019)</small></h3>
							</div>
